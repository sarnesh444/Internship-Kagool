...
![alt text](https://github.com/sarnesh444/Internship-Kagool/tree/master/onboardingtaskAzureandPBIintro)


## Day 8 May 9th 2020
#### Task was to explore the COVID-19 Dashboard built at Kagool Analytics using Power-BI
I was amazed to see how intutive the visualizations were,I have always believed "A picture Speaks a Thousand Words" you might have the best team creating models but what makes it intutive and understandable to everyone is Business-Intelligence has the responsibility of presenting the insights gained from data.
![alt text](https://www.linkedin.com/posts/kagool-ltd_powerbi-azurecloud-activity-6656096473693904896-rjsW)
...
The All-Hands-Meet was'nt quite new to my arena,being an operations member with demonstrated history of actively taking part in meets and events BUT THIS WAS A DIFFERENT BALL GAME(the product-walkthroughs RnR for achievers all felt so nice)
We also had a session of soap-box "A mainstream topic(overview of various SDLCs) with a narrative mastery" LITERALLY WOW!
